...
module pygrab 
	# module for getting access to astroquery python modules
	using PythonCall
	astropy()    = pyimport("astropy")    # for dealing with FITS python objects
	pyFIT()      = pyimport("astropy.io")
	astroquery() = pyimport("astroquery") # astroquery
	sdss() 		 = pyimport("astroquery.sdss") # astroquery.sdss
end
...
manifest_format = "2.0"
project_hash = "a8e81e190383c2de8eac453dac4b617f4eafba8d"
